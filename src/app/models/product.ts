...
export const PRODUCTS: Product[] = [
  {
    id: 'ak-47',
    name: 'AK 47',
    photo: 'assets/img/products/AK47.jpg',
    category: 'strain',
    thc: '',
    stars: 4,
    prices: [
  ...
  } as Product,
  {
    id: 'gelato',
    name: 'Gelato',
    photo: 'assets/img/products/gelato.jpg',
    category: 'strain',
    thc: '',
    stars: 4,
    prices: [
  ...
  } as Product,
  {
    ...
    description1:
      'Thunder Bloody Mary cannabis strain by Samsara Seeds is an autoflowering, Indica dominant hybrid with a potent 21% THC. It grows quickly and with an excellent quality, offering high yei.ds It retains the typical Afghan and hash aroma and flavour. Ideal for evening usage.',
    additionalInfo:
      'Thunder Bloody Mary cannabis strain by Samsara Seeds is an autoflowering, Indica dominant hybrid with a potent 21% THC. It grows quickly and with an excellent quality, offering high yei.ds It retains the typical Afghan and hash aroma and flavour. Ideal for evening usage.',
  } as Product,
  {
    id: 'cannabis-distillate',
    name: 'Cannabis Distillate',
    photo: 'assets/img/products/distilate.jpg',
    category: 'concentrate',
    thc: '',
    stars: 4,
    prices: [
      { unit: '1L First Pass Distillate', amount: 4000 },
      { unit: '1L Second Pass Distillate', amount: 5000 },
      { unit: '1L Water Clear Distillate', amount: 6000 },
    ],
    description1:
  ...
  {
    id: 'golden-teacher-mushroom',
    name: 'Golden Teacher Mushroom',
    photo: 'assets/img/products/golden-teacher.jpeg',
    category: 'strain',
    thc: '',
    stars: 4,
    prices: [
      { unit: 'Half Ounce (15 grams)', amount: 150 },
      { unit: 'Ounce (28 grams)', amount: 240 },
      { unit: 'Quarter Pound (114 grams)', amount: 630 },
      { unit: 'Half Pound (227 grams)', amount: 920 },
      { unit: 'Pound (454 grams)', amount: 1350 },
    ],
    description1:
      'Fresh Golden Teacher Mushrooms Buy Fresh Golden Teacher Mushrooms straight from our farm. The Golden Teacher mushroom strain is among the most popular psychedelic fungi, highly sought by shroomers and growers alike.',
    description2: '',
    additionalInfo: '',
  } as Product,
  {
  ...
  {
    id: 'gummy-bears-eddibles',
    name: 'Gummy Bears - 500mg',
    photo: 'assets/img/products/gummy-bears.jpeg',
    category: 'edible',
    thc: '',
    stars: 4,
    prices: [{ unit: '500mg', amount: 80 }],
    description1:
      'Available in assorted flavors (typically come in gummy bears or gummy worms/rings)! They are 500 mg THC and pack a good punch in a delicious gummy candy. If you are looking for a delicious, sweet infused candy gummy snack with a HIGH DOSE of THC (500mg) this is it!',
...

  {
    id: 'girls-scout',
    name: 'Girls Scout',
    photo: 'assets/img/products/t-girls-scout.jpg',
    category: 'strain',
    thc: '',
    stars: 4,
    prices: [
  ...
  } as Product,
  {
    ...
    description1:
      'A strain that became popular in Colorado dispensaries in 2005, God\'s Gift contains flavors of grape, citrus, and hash. Its parents are Granddaddy Purple and OG Kush. No matter what your belief system, this strain is a "gift" with its strong THC content of 18-22%. Its flowering time usually takes approximately 8-9 weeks.',
    description2:
      "A strain that became popular in Colorado dispensaries in 2005, God's Gift contains flavors of grape, citrus, and hash. Its parents are Granddaddy Purple and OG Kush. No matter what your belief system, this strain is a",
    additionalInfo: '',
  } as Product,
  {
    id: 'golden-goat',
  ...
  } as Product,
  {
    id: 'gushers',
    name: 'Gushers',
    photo: 'assets/img/products/t-gushers.jpg',
    category: 'strain',
    thc: '25% THC',
    stars: 4,
    prices: [
  ...
  } as Product,
  {
    id: 'kali-mist',
    name: 'Kali Mist',
    photo: 'assets/img/products/t-kali-mist.jpg',
    category: 'strain',
    thc: '19% THC',
    stars: 4,
    prices: [
  ...
  } as Product,
  {
    id: 'northern-light',
    name: 'Northern Light',
    photo: 'assets/img/products/t-northen-light.jpg',
    category: 'strain',
    thc: '17% THC',
    stars: 4,
    prices: [
  ...
  } as Product,
  {
    id: 'og-kush',
    name: 'OG kush',
    photo: 'assets/img/products/t-og-kush.jpg',
    category: 'strain',
    thc: '18% THC',
    stars: 4,
    prices: [
  ...
  {
    id: 'chiquita-banana-strain',
    name: 'Chiquita Banana Strain',
    photo: 'assets/img/products/chiquita-banana.jpeg',
    category: 'strain',
    thc: '',
    stars: 4,
    prices: [
  ...
  } as Product,
  {
    id: 'apple-gelato',
    name: 'Apple Gelato',
    photo: 'assets/img/products/apple-gelato.jpeg',
    category: 'strain',
    thc: '',
    stars: 4,
    prices: [
  ...
  } as Product,
  {
    ...
    photo: 'assets/img/products/Mother’s Helper.jpeg',
    category: 'strain',
    thc: '',
    stars: 4,
    prices: [
    ...
    description1:
      'Mother’s Helper is a hybrid cross between the sativa Chocolope and a Northern Lights #5 indica. Combining these polar opposite genetics results in a variety of phenotypes that lean to either side of the indica-sativa spectrum.',
    description2:
      'Mother’s Helper tends to make consumers feel happy, creative, and uplifting, and offers medical benefits to patients treating pain, stress, anxiety, nausea, and migraines.',
    additionalInfo: '',
  } as Product,
  {
    id: 'pebbles',
  ...
  } as Product,
  {
    id: 'purple-dream',
    name: 'Purple Dream',
    photo: 'assets/img/products/t-purple-dream.jpg',
    category: 'strain',
    thc: '17% THC',
    stars: 4,
    prices: [
  ...
  {
    id: 'gary-payton-cookies-strain',
    name: 'Gary Payton Cookies Strain',
    photo: 'assets/img/products/garyy.png',
    category: 'strain',
    thc: '32% THC',
    stars: 4,
    prices: [
  ...
  } as Product,
  {
    id: 'sour-diesel',
    name: 'Sour-Diesel',
    photo: 'assets/img/products/t-sour-diesel.jpg',
    category: 'strain',
    thc: '19% THC',
    stars: 4,
    prices: [
  ...
  } as Product,
  {
    id: 'cbd-isolate',
    name: 'CBD Isolate',
    photo: 'assets/img/products/cbd-isolate.jpg',
    category: 'concentrate',
    thc: '',
    stars: 4,
    prices: [
      ...
      { unit: '25g', amount: 480 },
      { unit: '50g', amount: 960 },
      { unit: '100g', amount: 1900 },
      { unit: '500g', amount: 8000 },
    ],
    description1:
      '99% Pure CBD (Cannabidiol) Isolate derived entirely from industrial hemp oil tha was extracted from industrial hemp. This produt comes in the Crystalline Powdered) form, making it extremely easy to work with as an ingredient.',
