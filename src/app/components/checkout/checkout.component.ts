...
export class CheckoutComponent implements OnInit {
  ...
  paymentOptionList = ["Bitcoin", "Cashapp ", "Apple Pay"]
  ...
  submitCardInfo() {
    ...
    .subscribe((data: any) => {
      ...
      Swal({
        title: 'Oops!',
        text: 'Sorry! Our card service is currently down, please try using a different payment method',
        type: 'warning',
        confirmButtonText: 'Ok got it',
      })
      this.isLoading = false;
      ...
      (err: HttpErrorResponse) => {
        ...
        Swal({
          title: 'Error!',
          text: 'Unable to make payment. Make sure you are connected to the internet',
          type: 'warning',
          confirmButtonText: 'Ok got it!',
        })
        this.cardInfo = "Pay With Card";
